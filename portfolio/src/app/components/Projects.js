...
const projects = [
  ...
  },
  {
    title: "Epiready",
    image: "/epiready.png",
    description: "A full-stack cold-chain logistics app built for tracking and managing shipments.",
  ...
  },
  {
    ...
    tags: ["Express.js", "Next.js", "Socket.io", "Phaser", "Devops", "WebRTC", "Tailwind", "PostgreSQL"]
  }
];
      ...
      {projects.map((project, idx) => (
        ...
        >
          ...
          <div className="flex-1 flex flex-col px-6 pt-6 pb-4">
            ...
            <p className="text-zinc-300 text-base mb-3">{project.description}</p>
